...
@XmlRootElement(name = "darsteller")
public class Darsteller {

    @XmlElement(required = true)
    protected Darsteller.Bild bild;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link Darsteller.Bild }
     *     
     */
    public Darsteller.Bild getBild() {
        return bild;
    }
     ...
     *     
     */
    public void setBild(Darsteller.Bild value) {
        this.bild = value;
    }
