...
public class ProfileService {
	...
	/**
	 * Marshalt die ver�nderte XML-Datei "ProfilXML.xml".
	 * 
	...
	/**
	 * Nimmt die ID des letzten Objekts "Profil" in der Liste und erh�ht diese um
	 * eins.
	 * 
	...
	/**
	 * Gibt eine Liste aller vorhandenen Profile zur�ck.
	 * 
	 * 
	...
	/**
	 * Gibt ein bestimmtes Profil mit der ID "profil_id" zur�ck
	 * 
	...
	/**
	 * Erstellt ein neues Profil und f�gt diese zur vorhandenen Liste hinzu, die
	 * ID ist dabei die des letzten Objekts in der Liste um eins erh�ht.
	 * 
	 * Das Objekt p muss in der XML-Struktur des Profils �bergeben werden.
	 * 
	...
	/**
	 * Ver�ndert ein bereits vohandenes Profil oder f�gt eins hinzu, wenn es
	...
	/**
	 * L�scht das Profil mit der �bergebenen ID.
	 * 
	 * @param profil_id ID des zu l�schenden Profils
	 * @return Status-Code ok bei Erfolg, wenn nicht dann Code 404 als Fehler
	 * @throws JAXBException
	 * @throws FileNotFoundException
	 */
	...
	public Response deleteProfil(@PathParam("profil_id") String profil_id) throws JAXBException, FileNotFoundException {
		...
		for (int i = 0; i < profil_daten.getProfil().size(); i++) {
			...
			if (profil_id.equals(profil_daten.getProfil().get(i).getId())) {
				...
				marshalProfil(profil_daten);
				System.out.println("Profil wurde gel�scht");
				return Response.ok().build();
			}
		}
	...
	/**
	 * Gibt eine Liste alle Filterobjekte zur�ck.
	 * 
	...
	/**
	 * Erstellt einen neuen Filter und f�gt diese zur vorhandenen Liste hinzu, die
	 * ID ist dabei die des letzten Objekts in der Liste um eins erh�ht.
	 * 
	 * Das Objekt f muss in der XML-Struktur der Filter �bergeben werden.
	 * 
	...
	/**
	 * L�scht den Filter mit der �bergebenen ID "filter_id".
	 * 
	 * @param profil_id ID des Profils, dem der Filter zugeordnet ist
	 * @param filtername Name des zu l�schenden Filter-Objekts
	 * @return Status-Code ok bei Erfolg, wenn nicht dann Code 404 als Fehler
	 * @throws JAXBException
	 * @throws FileNotFoundException
	 */
	...
	public Response deleteFilter(@PathParam("profil_id") String profil_id,
		...
		for (int i = 0; i < f_list.getFilter().size(); i++) {
			...
			if (filtername.equals(f_list.getFilter().get(i).getId())) {
				...
				marshalProfil(profil_daten);
				System.out.println("Filter wurde gel�scht");
				return Response.ok().build();
			}
		}
	...
	/**
	 * F�gt eine Serie dem Filter hinzu
	 * 
	 * @param profil_id ID des Profils, dem der Filter zugeordnet ist
	 * @param filtername Name des Filters, dem die Serie hinzugef�gt werden soll 
	 * @param serienname Serie die hinzugef�gt werden soll
	 * @return Status-Code ok bei Erfolg, wenn nicht dann Code 404 als Fehler
	 * @throws JAXBException
	 * @throws FileNotFoundException
	 */
	...
	/**
	 * L�scht eine bestimmte Serie aus dem Filter
	 * 
	 * 
	 * @param profil_id ID des Profils, dem der Filter zugeordnet ist
	...
	public Response deleteSerieInFilter(
		...
		for(int i=0; i<f_list.getFilter().size(); i++){
			...
			marshalProfil(profil_daten);
			System.out.println("Serie wurde aus Filter gel�scht");
			return Response.ok().build();
					}
				}
			}
	...
	/**
	 * Gibt eine Liste aller Abo-Objekte, die abonnierten Serien, zur�ck.
	 * 
	...
	/**
	 * Erstellt ein neues Serien-Objekt, das der Liste der Serien im Abo hizugef�gt wird.
	 * 
	 * 
	 * @param profil_id ID des Profils, dem das Abo zu geordnet ist
	 * @param serie die Serie, die neu zu der Liste Serien im Abonnement hinzugef�gt werden soll
	 * @return Status-Code ok bei Erfolg, wenn nicht dann Code 404 als Fehler
	 * @throws JAXBException
	 * @throws FileNotFoundException
	 */
	...
	/**
	 * L�scht die Serie mit dem �bergebenen Namen.
	 * 
	 * @param profil_id ID des Profil, dem das Abo zugeordnet ist
	 * @param serie die zu l�schende Serie
	 * @return Status-Code ok bei Erfolg, wenn nicht dann Code 404 als Fehler
	 * @throws JAXBException
	 * @throws FileNotFoundException
	 */
	...
	public Response deleteAbonnierteSerie(
		...
		for(int i=0; i<s_list.getSerie().size(); i++){
			...
			marshalProfil(profil_daten);
			System.out.println("Abonnierte Serie wurde gel�scht");
			return Response.ok().build();
		}	
