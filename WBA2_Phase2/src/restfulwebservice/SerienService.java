...
public class SerienService {
	...
	@Path("/{serie}")
	@Produces(MediaType.APPLICATION_XML)
	public Serie getSerie(@PathParam("serie") String serie) throws JAXBException, FileNotFoundException{
	...
	public String getSerienID(@PathParam("serie") String serie) throws JAXBException, FileNotFoundException{
	...
	@Path("/{serie}")
	@Produces(MediaType.APPLICATION_XML)
	public Response deleteSerie(@PathParam("serie") String serie) throws JAXBException, FileNotFoundException{
			Serien s_daten = unmarshalSerien();
			for(int i=0; i<s_daten.getSerie().size(); i++){
				if(serie.equals(s_daten.getSerie().get(i).getName())){
	...
	@Produces(MediaType.APPLICATION_XML)
	public Response postSerie(Serie s) throws JAXBException, FileNotFoundException{
		Serien s_daten = unmarshalSerien();
    ...
    @Consumes(MediaType.APPLICATION_XML)
    @Produces(MediaType.APPLICATION_XML)
    public Response putSerie(@PathParam("serien_id") String serien_id,    						
 		   					Serie s) throws JAXBException, FileNotFoundException{
 	   Serien s_daten = unmarshalSerien();
    ...
    @Path("/{serie}/staffel")
	@Produces( MediaType.APPLICATION_XML )
	public AlleStaffeln getStaffeln(@PathParam("serie") String serie) throws JAXBException, FileNotFoundException{
		Serie s  = getSerie(serie);
	...
	public Staffel getStaffel(@PathParam("serie") String serie,
							 @PathParam("staffel_id") String staffel_id) throws JAXBException, FileNotFoundException{
    ...
    @Consumes(MediaType.APPLICATION_XML)
	@Produces(MediaType.APPLICATION_XML)
	public Response postStaffel(@PathParam("serie") String serie,
			 					Staffel st) throws JAXBException, FileNotFoundException{
    	Serien s_daten = unmarshalSerien();
    	AlleStaffeln st_list = getStaffeln(serie);	   
	 ...
	 public Response deleteStaffel(@PathParam("serie") String serie,
	   		...
	   		for(int i=0; i<st_list.getStaffel().size(); i++){
	   			if(staffel_id.equals(st_list.getStaffel().get(i).getId())){
	   				s_daten.getSerie().get(Integer.parseInt(getSerienID(serie))-1).getAlleStaffeln().getStaffel().remove(i);
	   				marshalSerien(s_daten);
    ...
    public Response putStaffel(@PathParam("serie") String serie,
	   ...
	   for(int i=0; i<s_list.getStaffel().size(); i++ ){
		   if(s_id.equals(s_list.getStaffel().get(i).getId())){
			   ...
			   st.setId(id);
			   s_daten.getSerie().get(i).getAlleStaffeln().getStaffel().set((Integer.parseInt(id)-1), st);
			   break;
	...
	public Episode getEpisode(@PathParam("serie") String serie,
							 @PathParam("staffel_id") String staffel_id,
							 @PathParam("episoden_id") String episoden_id) throws JAXBException, FileNotFoundException{
    ...
    public Response postEpisode(@PathParam("serie") String serie,
			 					@PathParam("staffel_id") String staffel_id,
			 					Episode e) throws JAXBException, FileNotFoundException{
    	Serien s_daten = unmarshalSerien();
    	int s_id = Integer.parseInt(getSerienID(serie));
    ...
    public Response deleteFilter(@PathParam("serie") String serie,
	    	...
	    	List<Episode> st_list = s_daten.getSerie().get((s_id-1)).getAlleStaffeln().getStaffel().get((st_id-1)).getEpisode();		   	
    ...
    @Path("/{serie}/cast")
	@Produces( MediaType.APPLICATION_XML )
    public Cast getCast(@PathParam("serie") String serie) throws JAXBException, FileNotFoundException{
    	Serie s = getSerie(serie);
    	Cast c = s.getCast();
    ...
    @Consumes(MediaType.APPLICATION_XML)
    @Produces(MediaType.APPLICATION_XML)
    public Response putCast(@PathParam("serie") String serie, Cast c) throws JAXBException, FileNotFoundException{
    	Serien s_daten = unmarshalSerien();
    	int s_id = Integer.parseInt(getSerienID(serie));
